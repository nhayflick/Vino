...
(function() {
  this.JST || (this.JST = {});
  this.JST["main/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class=\'main-page\'><h4>Welcome to Vino</h4>\n<p>\n<input type="text" class="search-query">\n</p>\n\n<button class="btn btn-primary search">Search</button>\n</div>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["queries/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<input type="text" class="search-query">\n\n<button class="btn btn-primary search">Search</button>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["queries/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class=\'center\'>\n<video src="', vine.escape('url'),'" width="480" height="480" preload="none"controls class="vine-clip"></video>\n\n<h4>', vine.escape('text'),'</h4>\n</div>\n');}return __p.join('');};
}).call(this);
(function() {
  this.JST || (this.JST = {});
  this.JST["results/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<ul class="all-vines">\n</ul>\n');}return __p.join('');};
}).call(this);
(function() {
  jQuery(function() {
